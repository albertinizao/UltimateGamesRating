...
@EnableSwagger2
@ComponentScan(basePackages = {"com.opipo.ultimategamesrating"})
public class UltimateGamesRatingApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(UltimateGamesRatingApplication.class, args);
	}
